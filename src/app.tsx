  ...
  return (
    <>
      <a
        ...
        style="left: 15px"
        target="_blank"
        href="https://github.com/nazhard/today-task">
        {github}
      </a>
      <button
        onClick={isShow}
...
export default function App() {
  ...
  const [newDescription, setDescription] = createSignal("")
  const [tasks, setTasks] = createLocalStore<TodoItem[]>("tasks", [])
